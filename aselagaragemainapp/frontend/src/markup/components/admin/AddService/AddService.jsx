...
import Auth from "../../../../util/auth"; // Import the Auth function to check authorization
import "./AddService.css";
import { useAuth } from "../../../../context/AuthContext"; // Import the useAuth hook to access authentication state
import serviceService from "../../../../services/service.service"; // Import the service service to handle API calls related to services
const AddService = () => {
